...
# [P] IDENTIFICAÇÃO DE NOVO MEMBRO NO GRUPO
# [P] VERIFICAR SE NOVO MEMBRO É UM BOT (FLAG DO TELEPOT) E EXPULSÁ-LO CASO AFIRMATIVO
# [P] CAPTCHA SIMPLES PARA TESTAR SE NOVO MEMBRO É SPAMMER
# [P] TIMEOUT PARA EXPULSÃO CASO NÃO RESPONDA O CAPTCHA
# [P] VERIFICAR SAÍDA DE MEMBROS
